...
## Этап 1
- [X] Выбрать, скомпилировать проект, с реализованной обратной трассировкой лучей (Path Tracer). Это может быть как версия для CPU, так и для GPU, например, https://github.com/knightcrawler25/GLSL-PathTracer.
